...
_Catatan: Ganti `<URL_REPOSITORY_GITHUB_ANDA>` dengan link repository GitHub Anda._
...
_(Untuk Windows CMD jika perintah di atas tidak berjalan: `copy .env.example .env`)_
...
_Perintah ini akan secara otomatis mengunduh (jika belum ada) dan menjalankan image **PostgreSQL** dan **Redis** di background PC Anda pada port default masing-masing (5432 & 6379)._
